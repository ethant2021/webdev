var name = document.querySelector('.intro');
...
gsap.timeline({delay:0.2})
    ...
    .set('.projTitle', {opacity:0})
    .set('.contactTitle', {opacity:0})
    ...
    .timeScale(1.45) 
    .to('.txt1',    {duration:1.5, opacity:0, ease:Power3.easeInOut}, '-=1.2')
    .to('.projTitle',       {duration:1.5, opacity:1, ease:Power3.easeInOut}, '-=1.2')
    .to('.contactTitle',    {duration:1.5, opacity:1, ease:Power3.easeInOut}, '-=1.2')
    .timeScale(1)
